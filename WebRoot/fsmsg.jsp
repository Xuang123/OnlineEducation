							...
							<div class="card card-plain">
								...
								<div class="content table-responsive table-full-width">
									<table class="table table-hover">
										...
										<tbody>
											<s:iterator value="list" var="smsg">
												<tr>
													<td></td>
													<td><s:property value="#smsg.TUserByReceiveId.regname" /></td>
													<td><s:property value="#smsg.senddate" /></td>
													<td><s:url action="fsmsginfo" var="infourl">
															<s:param name="msgid">
																<s:property value="#smsg.id" />
															</s:param>
														</s:url> <s:a href="%{infourl}">
															<s:property value="#smsg.name" />
														</s:a></td>
												</tr>
											</s:iterator>
										</tbody>
							...
							<div class="card">
								<div class="content">
									<div class="row">
										...
										<div class="col-md-3">
											<ul class="pagination">
												<li><s:url action="fsmsgget" var="preurl">
												...
												<li><s:url action="fsmsgget" var="nexturl">
