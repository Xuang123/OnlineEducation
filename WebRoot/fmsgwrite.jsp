				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-8 col-md-7">
									...
									<div class="row">
										<div class="col-md-12">
											<ul class="nav nav-pills">
												...
												<li class="active"><s:a href="fmsgwrite.jsp">写信</s:a></li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="card">
								<div class="content">
									<form action="fmsgsend">
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													<label>收件人</label> <input type="text"
														class="form-control border-input" name="receivename" value=<s:property value="msginfo.receivename" />>
												</div>
											</div>
										</div>
										<div class="row">
											<div class="col-md-12">
												<label>标题</label> <input type="text"
													class="form-control border-input" name="name" value=<s:property value="msginfo.name" />>
											</div>
		 								</div>
										<div class="row">
											<div class="col-md-12">
												...
												<textarea rows="5" class="form-control border-input"
													name="content"><s:property value="msginfo.content" /></textarea>
											</div>
										</div>
										<div class="text-center">
											<button type="submit" class="btn btn-info btn-fill btn-wd">发送</button>
										</div>
